/**h* SpringCardNFC/RtdSmartPoster
 *
 * NAME
...
namespace SpringCardNFC
{
	...
	/**c* SpringCardNFC/RtdSmartPosterAction
	 *
	 * NAME
	...
	public class RtdSmartPosterAction : Rtd
	{
		...
		/**v* SpringCardNFC/RtdSmartPosterAction.Value
		 *
		 * SYNOPSIS
		 *   	public int Value
		 * 
	...
	/**c* SpringCardNFC/RtdSmartPosterTargetIcon
	 *
	 * NAME
	...
	/**c* SpringCardNFC/RtdSmartPosterTargetSize
	 *
	 * NAME
	...
	public class RtdSmartPosterTargetSize : Rtd
	{
		...
		/**v* SpringCardNFC/RtdSmartPosterTargetSize.Value
		 *
		 * SYNOPSIS
		 *   	public int Value
		 * 
	...
	/**c* SpringCardNFC/RtdSmartPosterTargetType
	 *
	 * NAME
	...
	public class RtdSmartPosterTargetType : Rtd
	{
		...
		/**v* SpringCardNFC/RtdSmartPosterTargetType.Value
		 *
		 * SYNOPSIS
		 *   	public string Value
		 * 
	...
	/**c* SpringCardNFC/RtdSmartPoster
	 *
	 * NAME
	 *   RtdSmartPoster
	 * 
