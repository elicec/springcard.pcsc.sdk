...
namespace SpringCardNFC
{
	...
	public class Ndef
	{
		...
		/**m* SpringCardNFC/Ndef.SetMessageBegin
		 *
		 * SYNOPSIS
		...
		/**m* SpringCardNFC/Ndef.SetMessageEnd
		 *
		 * SYNOPSIS
		...
		/**m* SpringCardNFC/Ndef.NdefFoundCallback
		 *
		 * SYNOPSIS
