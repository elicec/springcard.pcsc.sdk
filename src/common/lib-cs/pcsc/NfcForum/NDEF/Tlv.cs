...
namespace SpringCardNFC
{
	...
	public class NfcTlv
	{
		...
		/**m* SpringCardNFC/NfcTlv.Serialize
		 *
		 * SYNOPSIS
		...
		/**m* SpringCardNFC/NfcTlv.Unserialize
		 *
		 * SYNOPSIS
		...
		/**m* SpringCardNFC/NfcTlv.add_child
		 *
		 * SYNOPSIS
		...
		/**m* SpringCardNFC/NfcTlv.get_child
		 *
		 * SYNOPSIS
		...
		/**m* SpringCardNFC/NfcTlv.count_children
		 *
		 * SYNOPSIS
