...
namespace SpringCardNFC
{
	...
	public class RtdVCard : RtdMedia
	{
		...
		/**v* SpringCardNFC/RtdVCard.Nickname
		 *
		 * SYNOPSIS
		...
		/**v* SpringCardNFC/RtdVCard.Email_alternative
		 *
		 * SYNOPSIS
		...
		/**v* SpringCardNFC/RtdVCard.Pager
		 *
		 * SYNOPSIS
		 *   public string Pager
		 * 
		...
		/**v* SpringCardNFC/RtdVCard.Home_phone
		 *
		 * SYNOPSIS
		...
		/**v* SpringCardNFC/RtdVCard.Cell_phone
		 *
		 * SYNOPSIS
		...
		/**v* SpringCardNFC/RtdVCard.First_name
		 *
		 * SYNOPSIS
		...
		/**v* SpringCardNFC/RtdVCard.Family_name
		 *
		 * SYNOPSIS
		...
		/**v* SpringCardNFC/RtdVCard.Business_phone
		 *
		 * SYNOPSIS
		...
		/**v* SpringCardNFC/RtdVCard.Email
		 *
		 * SYNOPSIS
		 *   public string Email
		 * 
		...
		/**v* SpringCardNFC/RtdVCard.Birthday
		 *
		 * SYNOPSIS
		...
		/**v* SpringCardNFC/RtdVCard.Country
		 *
		 * SYNOPSIS
		...
		/**v* SpringCardNFC/RtdVCard.Address2
		 *
		 * SYNOPSIS
		...
		/**v* SpringCardNFC/RtdVCard.Address1
		 *
		 * SYNOPSIS
		...
		/**v* SpringCardNFC/RtdVCard.Post_Code
		 *
		 * SYNOPSIS
		...
		/**v* SpringCardNFC/RtdVCard.Region_State
		 *
		 * SYNOPSIS
		...
		/**v* SpringCardNFC/RtdVCard.Title
		 *
		 * SYNOPSIS
		 *   public string Title
		 * 
		...
		/**v* SpringCardNFC/RtdVCard.Company
		 *
		 * SYNOPSIS
		...
		/**v* SpringCardNFC/RtdVCard.Pro_Address1
		 *
		 * SYNOPSIS
		...
		/**v* SpringCardNFC/RtdVCard.Pro_Address2
		 *
		 * SYNOPSIS
		...
		/**v* SpringCardNFC/RtdVCard.Pro_Post_Code
		 *
		 * SYNOPSIS
		...
		/**v* SpringCardNFC/RtdVCard.Pro_Region_State
		 *
		 * SYNOPSIS
		...
		/**v* SpringCardNFC/RtdVCard.Pro_Town
		 *
		 * SYNOPSIS
		...
		/**v* SpringCardNFC/RtdVCard.Pro_Country
		 *
		 * SYNOPSIS
		...
		/**v* SpringCardNFC/RtdVCard.Middle_name
		 *
		 * SYNOPSIS
		...
		/**v* SpringCardNFC/RtdVCard.Prefix_name
		 *
		 * SYNOPSIS
		...
		/**v* SpringCardNFC/RtdVCard.Suffix_name
		 *
		 * SYNOPSIS
		 *   public string Prefix_name
		 * 
		...
		/**m* SpringCardNFC/RtdVCard.set_photo
		 *
		 * SYNOPSIS
		...
		/**m* SpringCardNFC/RtdVCard.get_photo
		 *
		 * SYNOPSIS
		...
		/**m* SpringCardNFC/RtdVCard.set_input_texts
		 *
		 * SYNOPSIS
