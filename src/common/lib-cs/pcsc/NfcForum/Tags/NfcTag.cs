...
namespace SpringCardNFC
{
	public abstract class NfcTag
	{
		...
		/**m* SpringCardNFC/NfcTag.Content
		 *
		 * SYNOPSIS
		...
		/**m* SpringCardNFC/NfcTag.Recognize
		 *
		 * SYNOPSIS
		...
		/**m* SpringCardNFC/NfcTag.IsEmpty
		 *
		 * SYNOPSIS
		 *   public bool IsEmpty()
		 * 
		...
		/**m* SpringCardNFC/NfcTag.IsFormatted
		 *
		 * SYNOPSIS
		...
		/**m* SpringCardNFC/NfcTag.IsFormattable
		 *
		 * SYNOPSIS
		...
		/**m* SpringCardNFC/NfcTag.IsLocked
		 *
		 * SYNOPSIS
		...
		/**m* SpringCardNFC/NfcTag.IsLockable
		 *
		 * SYNOPSIS
		...
		/**m* SpringCardNFC/NfcTag.Capacity
		 *
		 * SYNOPSIS
		...
		/**m* SpringCardNFC/NfcTag.ContentSize
		 *
		 * SYNOPSIS
